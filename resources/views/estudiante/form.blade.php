<div class="row padding-1 p-1">
    <div class="col-md-12">
        ...
        <div class="form-group mb-2 mb20">
            ...
            <input type="text" name="fecha_nacimiento" class="form-control @error('fecha_nacimiento') is-invalid @enderror" value="{{ old('fecha_nacimiento', $estudiante?->fecha_nacimiento) }}" id="fecha_nacimiento" placeholder="Fecha Nacimiento">
        ...
        <div class="form-group mb-2 mb20">
            ...
            <input type="text" name="fecha_matricula" class="form-control @error('fecha_matricula') is-invalid @enderror" value="{{ old('fecha_matricula', $estudiante?->fecha_matricula) }}" id="fecha_matricula" placeholder="Fecha Matricula">
